...
module.exports = function(yargs, argv, convertOptions) {
	...
	if(configFiles.length > 0) {
		...
		var requireConfig = function requireConfig(configPath) {
			var options = require(configPath).dev();
	...
	function processOptions(options) {
		...
		ifArgPair("define", function(name, value) {
			...
			var DefinePlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'DefinePlugin'));//require("../lib/DefinePlugin");
		...
		ifBooleanArg("hot", function() {
			ensureArray(options, "plugins");
			var HotModuleReplacementPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'HotModuleReplacementPlugin'));//require("../lib/HotModuleReplacementPlugin");
			options.plugins.push(new HotModuleReplacementPlugin());
		});

		ifBooleanArg("debug", function() {
			ensureArray(options, "plugins");
			var LoaderOptionsPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'LoaderOptionsPlugin'));//require("../lib/LoaderOptionsPlugin");
		...
		ifArg("optimize-max-chunks", function(value) {
			ensureArray(options, "plugins");
			var LimitChunkCountPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'optimize', 'LimitChunkCountPlugin'));//require("../lib/optimize/LimitChunkCountPlugin");
		...
		ifArg("optimize-min-chunk-size", function(value) {
			ensureArray(options, "plugins");
			var MinChunkSizePlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'optimize', 'MinChunkSizePlugin'));//require("../lib/optimize/MinChunkSizePlugin");
		...
		ifBooleanArg("optimize-minimize", function() {
			ensureArray(options, "plugins");
			var UglifyJsPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'optimize', 'UglifyJsPlugin'));//require("../lib/optimize/UglifyJsPlugin");
			var LoaderOptionsPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'LoaderOptionsPlugin'));//require("../lib/LoaderOptionsPlugin");
		...
		ifArg("prefetch", function(request) {
			ensureArray(options, "plugins");
			var PrefetchPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'PrefetchPlugin'));//require("../lib/PrefetchPlugin");
		...
		ifArg("provide", function(value) {
			...
			var ProvidePlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'ProvidePlugin'));//require("../lib/ProvidePlugin");
