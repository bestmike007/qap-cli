...
// try {
// 	//require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'DefinePlugin'));
...
var yargs = require("yargs")
	.usage("webpack " + require(path.join(process.cwd(), "package.json")).version + "\n" +
		"Usage: https://webpack.github.io/docs/cli.html\n" +
		"Usage without config file: webpack <entry> [<entry>] <output>\n" +
		"Usage with config file: webpack");

require("./profile_webpack_config.js")(yargs);
...
var options = require("./profile_webpack_argv.js")(yargs, argv);
...
function processOptions(options) {
	...
	//require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'DefinePlugin'));//require("../lib/Stats.js")
	var statsPresetToOptions = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'Stats.js')).presetToOptions;
	...
	//require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'Stats.js'))
	var webpack = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'webpack.js'));//require("../lib/webpack.js");
	...
	try {
		...
		//require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'webpack.js'));
		var WebpackOptionsValidationError = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'WebpackOptionsValidationError'));//require("../lib/WebpackOptionsValidationError");
	...
	if(argv.progress) {
		//require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'WebpackOptionsValidationError'));
		var ProgressPlugin = require(Path.join(process.cwd(), 'node_modules', 'webpack', 'lib', 'ProgressPlugin'));//require("../lib/ProgressPlugin");
